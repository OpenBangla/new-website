  ...
  return (
    <Container className="py-28">
      <Flex className="justify-between">
        <Flex className="flex-col items-baseline gap-6">
          <h4 className="rounded-full bg-[#16CD8A]/25 px-5 py-2.5 font-medium text-[#06402B] text-sm">
            Open Source • Cross Platform
          </h4>

          <h1 className="max-w-2xl font-bricolage-grotesque font-extrabold text-5xl text-[#202020]">
            The Last{" "}
          ...
          <p className="max-w-xl font-medium text-[#5D5D5D] text-xl leading-8">
            Fast, smart Bangla typing with phonetic and fixed layouts Available
            on
